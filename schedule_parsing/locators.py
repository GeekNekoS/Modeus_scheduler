...
class ModeusLocators:
    ...
    ITIS_3_MODULE = (By.XPATH, f"//div[text()=' {ITIS} (онлайн, УрФУ, ОК, ИНЖ) ']")
    ITIS_4_MODULE = (By.XPATH, f"//div[text()=' {ITIS} (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты инженерного моделирования ']")
    ITIS_5_MODULE = (By.XPATH, f"//div[text()=' {ITIS} (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты работы с документами ']")
    ITIS_6_MODULE = (By.XPATH, f"//div[text()=' {ITIS} (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты твердотельного 3D-моделирования ']")
    ITIS_7_MODULE = (By.XPATH, f"//div[text()=' {ITIS}. Цифровые инструменты визуализации данных ']")
    ITIS_8_MODULE = (By.XPATH, f"//div[text()=' {ITIS}. Цифровые инструменты исследовательской деятельности ']")
    ITIS_9_MODULE = (By.XPATH, f"//div[text()=' {ITIS}. Цифровые инструменты моделирования для 3D-печати ']")
    ITIS_10_MODULE = (By.XPATH, f"//div[text()=' {ITIS}. Цифровые инструменты обработки данных ']")
