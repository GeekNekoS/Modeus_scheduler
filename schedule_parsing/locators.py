...
class ModeusLocators:
    ...
    ITIS_3_MODULE = (By.XPATH, "//td[@title='Информационные технологии и сервисы (онлайн, УрФУ, ОК, ИНЖ)']")
    ITIS_4_MODULE = (By.XPATH, "//td[@title='Информационные технологии и сервисы (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты инженерного моделирования']")
    ITIS_5_MODULE = (By.XPATH, "//td[@title='Информационные технологии и сервисы (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты работы с документами']")
    ITIS_6_MODULE = (By.XPATH, "//td[@title='Информационные технологии и сервисы (Смешанное, УрФУ, ОК). Мастерская Цифровые инструменты твердотельного 3D-моделирования']")
