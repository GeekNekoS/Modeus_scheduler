...
def create_personal_schedule(user_id, query):
    ...
    with open(f"temp_files\\schedule_{user_id}.txt", "r", encoding="utf-8") as f:
        available_study_teams = f.read()

    with open("sys_prompt.txt", "r", encoding="utf-8") as prompt_text:
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": sys_prompt + available_study_teams + avg_teacher_grades
            },
            {
                "role": "user",
